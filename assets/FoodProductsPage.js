  ...
  e.jsxs("div",{className:"max-w-7xl mx-auto px-4 py-8",children:[
    e.jsxs("div",{className:"flex flex-col lg:flex-row gap-8",children:[
      ...
      e.jsxs("div",{className:"flex-1",children:[
        ...
        fetchError&&products.length===0?e.jsxs("div",{className:"text-center py-20",children:[e.jsx("p",{className:"text-6xl mb-4",children:"⚠️"}),e.jsx("p",{className:"text-warm-600 font-medium",children:fetchError})]}):filtered.length===0?e.jsxs("div",{className:"text-center py-20",children:[
